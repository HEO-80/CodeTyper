...
const LANG_META = {
  ...
  english:    { label: "Inglés",          icon: "⬡", color: "#4ec994" },
  french:     { label: "Francés",         icon: "⬡", color: "#82aaff" },
  german:     { label: "Alemán",          icon: "⬡", color: "#ffcb6b" },
  italian:    { label: "Italiano",        icon: "⬡", color: "#f78c6c" },
  portuguese: { label: "Portugués",       icon: "⬡", color: "#4ec994" },
  romanian:   { label: "Rumano",          icon: "⬡", color: "#c792ea" },
  japan:      { label: "Japonés",         icon: "⬡", color: "#f89820" },
  czech:      { label: "Checo",           icon: "⬡", color: "#c792ea" },
  chinese:    { label: "Chino",           icon: "⬡", color: "#ff5555" },
  russian:    { label: "Ruso",            icon: "⬡", color: "#82aaff" },
  greek:      { label: "Griego",          icon: "⬡", color: "#89ddff" },
  korean:     { label: "Coreano",         icon: "⬡", color: "#ff5555" },
  ukrainian:  { label: "Ucraniano",       icon: "⬡", color: "#ffcb6b" },
};
